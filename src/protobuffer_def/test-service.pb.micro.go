...
func (c *testService) BaseInterface(ctx context.Context, in *BaseRequest, opts ...client.CallOption) (*BaseResponse, error) {
	req := c.c.NewRequest(c.name, "TestService.BaseInterface", in)
...
func (h *testServiceHandler) BaseInterface(ctx context.Context, in *BaseRequest, out *BaseResponse) error {
	return h.TestServiceHandler.BaseInterface(ctx, in, out)
}
